...
const steps = [
  {
    ...
    description:
      "Start with your raw prompt or import from your existing library",
  ...
  },
  {
    ...
    description:
      "Our AI engine optimizes your prompt for clarity and effectiveness",
...
const features = [
  {
    ...
    description:
      "Transform basic prompts into optimized, detailed instructions using advanced AI analysis.",
  ...
  },
  {
    ...
    description:
      "Compare responses across multiple AI models side-by-side to find the perfect match.",
  ...
  },
  {
    ...
    description:
      "Track prompt iterations, save successful variations, and build your prompt library.",
  ...
  },
  {
    ...
    description:
      "Organize prompts by projects, tags, and categories for efficient workflow management.",
...
export default function Hero() {
  return (
    <div className="min-h-screen relative pt-10">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div className={`transition-all duration-1000`}>
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-2xl">
              A powerful prompt engineering workspace to enhance, version, and
              test prompts across leading AI models.
            </p>
            ...
            <div className="relative">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-black/20 rounded-xl p-4 border border-green-500/30">
                    ...
                    <div className="text-green-300 font-mono text-sm">
                      "Create a comprehensive, engaging blog post about
              ...
              <div className="absolute -top-12 -right-2 sm:-right-6 md:-right-16 backdrop-blur-xl bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-2xl p-4 ">
                ...
                <div className="space-y-2">
                  {["GPT-4", "Claude"].map((item) => (
                    <div
                      key={item}
                      className="flex items-center text-gray-200 space-x-2"
                    >
              ...
              <div className="absolute -bottom-16 sm:-bottom-14 -right-2 sm:-right-6 md:-right-16 backdrop-blur-xl bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border border-cyan-500/30 rounded-2xl p-4">
                ...
                <div className="text-xs text-gray-200 space-y-2">
                  <div className="flex">
                    <Image src={up} alt="up" className="w-3 mx-[2px]" />{" "}
                    Quality: 94%
                  </div>
                  <div className="flex">
                    <Image src={down} alt="down" className="w-4" /> Response:
                    1.2s
                  </div>
                </div>
              </div>
      ...
      <section className="py-10 mt-5 sm:mt-18">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {steps.map((step, index) => (
              ...
              >
                <Card
                  className={`backdrop-blur-xl hover:scale-105 bg-gradient-to-br from-white/10 to-white/5 border-2 transition-all duration-500 ${step.border} hover:shadow-2xl ${step.glow}`}
                >
                  <CardContent className="p-8 text-center">
                    <div
                      className={`w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-to-r ${step.color} flex items-center justify-center shadow-lg`}
                    >
                      {step.icon}
                    </div>
      ...
      <section id="playground" className="py-10 mt-5 sm:mt-18">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              See your prompts transform in real-time and compare outputs across
              models
            </p>
          </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-2 sm:p-4">
                    ...
                    <div className="font-mono text-sm text-gray-300">
                      Create a compelling marketing email for our new product
                      launch that includes: a catchy subject line, personalized
                      greeting, clear value proposition highlighting 3 key
                      benefits, social proof or testimonials, strong
                      call-to-action, and professional closing. Target audience:
                      existing customers aged 25-45. Tone: enthusiastic but
                      professional. Length: 150-200 words.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-2 sm:p-4 min-h-[200px]">
                  ...
                  <div className="text-sm text-gray-300 leading-relaxed">
                    ...
                    Hi [Name],
                    <br />
                    We're thrilled to announce the launch of our revolutionary
                    new product that will transform how you work and elevate
                    your productivity to the next level. <br />
                    This innovation isn’t just a tool—it’s a complete shift in
                    how you approach daily tasks. With its intuitive interface,
                    powerful features, and seamless integration into your
                    workflow, you’ll be empowered to achieve more in less
                    time...
                  </div>
                </div>
              </div>
      ...
      {/* Features Grid */}
      <section id="features" className="py-10 mt-5 sm:mt-18">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card
                key={index}
                className={`backdrop-blur-xl bg-gradient-to-br ${feature.gradient} border-2 ${feature.border} hover:scale-105 transition-all duration-300 hover:shadow-2xl ${feature.glow} group`}
              >
                <CardContent className="p-8 text-center">
      ...
      {/* Final CTA Section */}
      <section className="py-10 mt-5 sm:mt-18 relative">
          ...
          <div className="backdrop-blur-xl bg-gradient-to-br from-gray-600/10 to-gray-100/5 border border-white/20 rounded-3xl p-8 px-4 sm:p-12 shadow-2xl shadow-purple-500/10 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
                Join thousands of developers and AI enthusiasts who are
                transforming their prompt engineering workflow.
              </p>
              <Button
                size="lg"
